                ...
                <div class="mt-10">
                    ...
                    <div class="flex flex-col mt-8">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            >
                                <tr
                                    v-for="(document, documentIndex) in $page.props.entity.documents"
                                    :key="documentIndex"
                                >
                                    <!--                                    <td class="px-6 py-4 font-medium text-gray-900">-->
                                    <!--&lt;!&ndash;                                        {{ $page.props.entity.prod }}&ndash;&gt;-->

                                    <!--&lt;!&ndash;                                        <ErrorMessage :error="$page.props.errors[`articles.${index}.id`]"/>&ndash;&gt;-->
                                    <!--                                    </td>-->
                                    <td class="px-6 py-4 font-medium text-gray-900">
...
export default {
    ...
    data() {
        return {
            filelist: [],
            documentType: null,
            // articles: this.$page.props.entity.articles,
            documents: [],
        };
    },
    methods: {
        ...
        saveDocuments() {
            ...
            formData.append('object_type',this.$page.props.entity_type);
            formData.append('object_id',this.$page.props.entity_id);
