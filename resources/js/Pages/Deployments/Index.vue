    ...
    <app-layout>
        ...
        <template #screen-actions>
            ...
            >
                ...
                <span class="text-sm">{{ $t("new_deployment") }}</span>
            </inertia-link>
        </template>
        ...
        <div class="screen__content">
            ...
            >
                ...
                <template #row="raw">
                    ...
                    <td class="px-2 font-medium text-center text-gray-900  flex items-center justify-center">
