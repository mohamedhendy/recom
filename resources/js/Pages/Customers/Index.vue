    ...
    <app-layout>
        ...
        <template #screen-actions>
            <inertia-link
                ...
                href="/updateFromEasyBill"
            >
                <svg-vue icon="refresh" class="w-4 h-4"/>
                <span class="text-sm">{{ $t("async_easy_bill_customers") }}</span>
            </inertia-link>
            ...
            >
                ...
                <span class="text-sm">{{ $t("new_customer") }}</span>
            </inertia-link>
        </template>
